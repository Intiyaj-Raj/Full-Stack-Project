        ...
        <div className="flex items-center justify-between h-16 relative">
          ...
          <div className="flex-1 mx-4">
            <div className="relative">
              <input
                ...
                name=""
                id=""
                className="w-full bg-gray-300 rounded-full pl-4 pr-10 py-2 shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            {!token ? (
              ...
              <IoLogOut
                className="text-xl font-semibold text-red-500 hover:cursor-pointer hover:text-red-700"
          ...
          {isOpen && (
            <div className="md:hidden bg-white px-10 pt-2 pb-4 space-y-2 shadow-2xl absolute top-16 right-0 w-full font-semibold ">
              <Link
                to={"/"}
                className="block text-gray-800 hover:text-purple-600 hover:underline"
              >
                Home
              </Link>
              <Link
              ...
              {!token ? (
                ...
                <button
                  onClick={handleLogOut}
                  className="block text-gray-800 hover:text-red-600 hover:underline"
                >
                  LogOut
                </button>
              )}
