  ...
  async function handleForm(e) {
    ...
    try {
      ...
      const response = await fetch(
        "https://full-stack-project-cw6d.onrender.com/api/userquery",
        {
          method: "POST",
  ...
  return (
    <div className="max-w-7xl mx-auto mt-24 p-6 bg-gray-200 rounded-xl">
      ...
      >
        ...
        <button className="w-full bg-purple-500 hover:bg-purple-700 text-white font-medium rounded-lg mt-3 py-2 transition-all duration-300 shadow-md">
          Submit Query
        </button>
      </form>
    </div>
