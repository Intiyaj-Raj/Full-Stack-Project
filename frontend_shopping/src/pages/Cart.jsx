    ...
    <div className="fixed inset-0 bg-black bg-opacity-45 backdrop-blur-sm flex justify-center items-center z-50">
      <div className="bg-white w-full max-w-xl p-6 rounded-xl shadow-md relative overflow-y-auto max-h-[90vh] mx-4">
        <button
          ...
          className="absolute top-3 right-3 text-xl text-gray-700 hover:text-red-600"
        >
          <IoIosCloseCircle />
        </button>
          ...
          <ul key={index} className="divide-y divide-gray-500">
            <li className="flex items-center gap-5 py-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  className="px-2 py-1 bg-purple-300 rounded hover:bg-purple-500"
                  onClick={() => {
                    dispatch(DecrementQunatity(value));
                  }}
                >
                  <FaMinus />
                </button>
              ...
              <MdDeleteSweep
                className="text-gray-700 hover:text-red-700 text-2xl hover:cursor-pointer"
                onClick={() => {
        ...
        <div className="mt-5 text-right">
          <p className="text-lg font-semibold text-gray-600">
            ...
            <span className="text-gray-700">{cartAllTotal.TotalQuantity}</span>
          </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-45 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="bg-white w-full max-w-md p-6 rounded-xl shadow-md relative mx-4">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-purple-600 text-white px-6 py-2 rounded hover:bg-purple-800"
              >
                Proceed to Payment
              </button>
            </form>
